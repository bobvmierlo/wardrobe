...
ACTION_LABELS: dict[str, str] = {
    ...
    "auth.password_change_failed": "Wachtwoordwijziging geweigerd",
    "auth.login_throttled": "Inlogpoging geblokkeerd",
    "auth.logout_everywhere": "Overal uitgelogd",
    "auth.registration_toggle": "Zelf registreren aan/uit",
    "auth.oidc_login": "Ingelogd via SSO",
    "auth.oidc_failed": "Mislukte SSO-login",
    "auth.oidc_link": "Account gekoppeld aan SSO",
    "auth.oidc_admin_sync": "Beheerdersrol via SSO bijgewerkt",
    "auth.oidc_admin_kept": "Beheerdersrol via SSO behouden",
    "auth.oidc_groups_missing": "SSO-login zonder groepen-claim",
    ...
    "user.self_register": "Zelf geregistreerd",
    ...
    "invitation.create_account": "Accountuitnodiging gemaakt",
